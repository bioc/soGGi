...
#' @rdname ChIPprofile
#' @export
#' @import BiocGenerics BiocParallel Biostrings GenomicAlignments GenomicRanges ggplot2 IRanges methods preprocessCore reshape2 Rsamtools rtracklayer chipseq S4Vectors
